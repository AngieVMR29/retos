import random
continuar=1
print("Usted esta ingresand a nuestros sistemas, por favor indique los siguientes datos: ")
...
if (len(celular)==10 and len(contraseña)==4):
    ...
    valorI=4500
    while continuar==1:
        proceso= int(input("Escoja el número que corresponde al proceso que quiere ralizar según el siguiente menú: \n 1. Saca \n 2. Envia \n 3. Recarga \n 4. Salir\n"))
        if proceso==1:
